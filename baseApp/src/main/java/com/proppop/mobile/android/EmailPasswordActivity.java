...
public class EmailPasswordActivity extends AbstractBaseActivity implements View.OnClickListener {
    ...
    private void loginSuccessfull() {
        ...
        Intent mainIntent = new Intent(this, MainBaseActivity.class);
